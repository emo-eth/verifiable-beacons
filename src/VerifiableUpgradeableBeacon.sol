...
contract VerifiableUpgradeableBeacon {
    ...
    function _setImplementation(address newImplementation) internal virtual {
        ...
        assembly {
            ...
            let _counter := shr(160, sload(_UPGRADEABLE_BEACON_IMPLEMENTATION_SLOT))
            ...
            sstore(_UPGRADEABLE_BEACON_IMPLEMENTATION_SLOT, packed)
    ...
    function counter() public view returns (uint256 result) {
        /// @solidity memory-safe-assembly
        assembly {
            result := shr(160, sload(_UPGRADEABLE_BEACON_IMPLEMENTATION_SLOT))
        }
    }
